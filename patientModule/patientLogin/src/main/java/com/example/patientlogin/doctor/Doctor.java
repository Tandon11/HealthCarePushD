...
public class Doctor {
    ...
    public void setPatient(List<AppUser> patient) {
    ...
    public Doctor(Long id, String fname, String lname, String gender, String highest_qual, String username, String contact_no, String is_Avail, String password, List<AppUser> appUsers) {
        Id = id;
        this.fname = fname;
        this.lname = lname;
        this.gender = gender;
